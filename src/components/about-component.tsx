...
export function AboutComponent() {
  return (
    <div className="flex flex-row gap-3 w-full h-104 mt-4">
      <div className="flex flex-col w-xl p-4 dark:bg-[#111111] border-b dark:border-none">
      ...
      <div>
        <div className="flex flex-col gap-4 min-w-65 h-90">
          <div className="flex flex-col gap-2 px-4 py-6 rounded-lg relative h-full w-full overflow-hidden border border-white/10 bg-linear-to-br from-[#0a0a0a] via-[#2b2b2b] to-[#0a0a0a] shadow-[0_0_40px_rgba(255,255,255,0.04)]">
            ...
            <div className="flex flex-row items-end justify-between mt-10">
              ...
              <QrCode color="gray" size={45} />
            </div>
          </div>
        </div>

        <div className="p-3 items-center flex flex-col w-full h-12 mt-2 bg-accent">
          <h1 className="font-quicksand font-semibold text-base text-black dark:text-white uppercase">Full Stack</h1>
        </div>
      </div>
    </div>
  );
